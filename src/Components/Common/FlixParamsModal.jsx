...
const FlixParamsModal = ({ isOpen, onClose, onSubmit, productName }) => {
  ...
  return (
    <div className="fixed text-xl inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="bg-green-50 border border-green-200 rounded-xl p-4">
            <p className="text-sm text-gray-700">
              Please provide information for: <span className="font-semibold text-green-800">{productName}</span>
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all duration-200 ${
                  errors.distributorID ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                }`}
            ...
            <div>
              <label htmlFor="mpn" className="block text-sm font-semibold text-gray-700 mb-2">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all duration-200 ${
                  errors.mpn ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                }`}
            ...
            <div>
              <label htmlFor="ean" className="block text-sm font-semibold text-gray-700 mb-2">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all duration-200 ${
                  errors.ean ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                }`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all duration-200 ${
                  errors.language ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                }`}
                placeholder="Enter language code (e.g., en, fr, de, es)"
                maxLength={5}
              />
              <p className="text-xs text-gray-500 mt-1">
                Enter 2-5 character language code (e.g., en for English, fr for French, de for German)
              </p>
              {errors.language && (
                <p className="text-red-500 text-sm mt-2 flex items-center">
                  <span className="w-1 h-1 bg-red-500 rounded-full mr-2"></span>
            ...
            <div>
              <label htmlFor="live" className="block text-sm font-semibold text-gray-700 mb-2">
                Live Mode *
              </label>
              <select
                id="live"
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-all duration-200 ${
                  errors.live ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                }`}
              >
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
            <p className="text-xs text-gray-600">
              <span className="font-semibold">Required fields:</span> Distributor ID, Language Code, Live Mode, and either MPN or EAN must be provided.
              <br />
              <span className="font-semibold">Language codes:</span> Use standard ISO codes like en, fr, de, es, it, etc.
              <br />
              <span className="font-semibold">Live Mode:</span> Use 1 for production, 0 for testing.
            </p>
          </div>
          ...
          <div className="flex space-x-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-6 py-2 border-2 border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 font-medium"
            >
              Cancel
            </button>
            <button
